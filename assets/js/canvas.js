...
function onLoad()
{
    ...
    folder = "https://github.com/Abendiix/spriteslove/blob/main/assets/img/images/";
}
...
function blue_blue()
{
    ...
    borderimg.src = "https://github.com/Abendiix/spriteslove/tree/main/assets/img/borders/blue_blue.png";
    ndsrow.style.display = "none";
    control.style.display = "flex";
    controladd.style.display = "none";
...
function blue_pink()
{
    ...
    borderimg.src = "https://github.com/Abendiix/spriteslove/tree/main/assets/img/borders/blue_pink.png";
    ndsrow.style.display = "none";
    control.style.display = "flex";
    controladd.style.display = "none";
    controlchange.style.display = "flex";
...
function blue_green()
{
    ...
    borderimg.src = "https://github.com/Abendiix/spriteslove/tree/main/assets/img/borders/blue_green.png";
    ndsrow.style.display = "none";
    control.style.display = "flex";
    controladd.style.display = "none";
    controlchange.style.display = "flex";
...
function dt_blue()
{
    ...
    borderimg.src = "https://github.com/Abendiix/spriteslove/tree/main/assets/img/borders/dt_blue.png";
    ndsrow.style.display = "none";
    control.style.display = "flex";
    controladd.style.display = "none";
    controlchange.style.display = "flex";
...
function dt_pink()
{
    ...
    borderimg.src = "https://github.com/Abendiix/spriteslove/tree/main/assets/img/borders/dt_pink.png";
    ndsrow.style.display = "none";
    control.style.display = "flex";
    controladd.style.display = "none";
    controlchange.style.display = "flex";
...
function dt_green()
{
    ...
    borderimg.src = "https://github.com/Abendiix/spriteslove/tree/main/assets/img/borders/dt_green.png";
    ndsrow.style.display = "none";
    control.style.display = "flex";
    controladd.style.display = "none";
    controlchange.style.display = "flex";
...
function sky_blue()
{
    ...
    borderimg.src = "https://github.com/Abendiix/spriteslove/tree/main/assets/img/borders/sky_blue.png";
    ndsrow.style.display = "none";
    control.style.display = "flex";
    controladd.style.display = "none";
    controlchange.style.display = "flex";
...
function sky_pink()
{
    ...
    borderimg.src = "https://github.com/Abendiix/spriteslove/tree/main/assets/img/borders/sky_pink.png";
    ndsrow.style.display = "none";
    control.style.display = "flex";
    controladd.style.display = "none";
    controlchange.style.display = "flex";
...
function sky_green()
{
    ...
    borderimg.src = "https://github.com/Abendiix/spriteslove/tree/main/assets/img/borders/sky_green.png";
    ndsrow.style.display = "none";
    control.style.display = "flex";
    controladd.style.display = "none";
    controlchange.style.display = "flex";
...
function mega()
{
    ...
    borderimg.src = "https://github.com/Abendiix/spriteslove/tree/main/assets/img/borders/mega.png";
    n3dsrow.style.display = "none";
    control.style.display = "flex";
    controladd.style.display = "none";
    controlchange.style.display = "flex";
...
function gates()
{
    ...
    borderimg.src = "https://github.com/Abendiix/spriteslove/tree/main/assets/img/borders/gates.png";
    n3dsrow.style.display = "none";
    control.style.display = "flex";
    controladd.style.display = "none";
    controlchange.style.display = "flex";
...
function dx()
{
    ...
    borderimg.src = "https://github.com/Abendiix/spriteslove/tree/main/assets/img/borders/dx.png";
    nswitchrow.style.display = "none";
    control.style.display = "flex";
    controladd.style.display = "none";
    controlchange.style.display = "flex";
